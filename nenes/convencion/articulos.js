...
const n = window.location.search.substring(1).split('=')[1]

const title = document.querySelector('#article h3');
title.textContent = articles[n].t;
document.title = articles[n].t;

const summary = document.querySelector('#summary');
summary.textContent = articles[n].s;

const content = document.querySelector('#content');

articles[n].c.forEach((p) => {
  ...
  if (p.prefix == 'none') {
    ...
    content.appendChild(prefixedParagraph);
  }
})
